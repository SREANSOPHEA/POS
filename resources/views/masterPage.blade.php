    ...
    <div class="layout-container">
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item {{ Request::is('admin/supplierReport') ? 'active' : '' }}">
            <a href="{{ url('/admin/supplierReport') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-user"></i>
              <div data-i18n="Analytics">Supplier Report</div>
            </a>
          </li>
          <li class="menu-item {{ Request::is('admin/membershipReport') ? 'active' : '' }}">
            <a href="{{ url('/admin/membershipReport') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-id-card"></i>
              <div data-i18n="Analytics">Membership Report</div>
            </a>
          </li>
