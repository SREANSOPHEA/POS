    ...
    <div class="d-flex align-items-end row">
        <div>
            <div class="d-flex justify-content-between align-items-center card-header">
                <h4 style="margin-bottom: 0px;"><strong><span><i>Membership-Report</i></span></strong></h4>
                <div>
                    <!-- PDF Button -->
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="saleReport">
                        ...
                        <tbody>
                            ...
                            {{-- @foreach($cus as $rw) --}}
                            <tr>
                                <td class="text-center"><strong>Super Heng</strong></td>
                                <td class="text-center"><strong>SL0101</strong></td>
                                <td class="text-center"><strong>19 Jan 2025</strong></td>
                                <td><span class="badge bg-label-primary me-1">Active</span></td>
                                <td class="text-center"><strong>$550</strong></td>
                                <td class="text-center"><strong>$550</strong></td>
                                <td class="text-center"><strong>$0.00</strong></td>
                                <td class="text-center"><span class="badge bg-label-success me-1"><strong>Paid</strong></span></td>
